...
const AccountCard = ({ account }) => {
    ...
    return (
        <div className="bg-white dark:bg-surface-dark2 p-5 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between group hover:border-indigo-100 dark:hover:border-indigo-900 transition-colors">
