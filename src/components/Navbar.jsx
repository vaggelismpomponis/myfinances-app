...
const Navbar = ({ activeTab, setActiveTab }) => {
    return (
        <div className="bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-800 px-6 pb-10 pt-2 z-10 sticky bottom-0 transition-colors duration-300">
