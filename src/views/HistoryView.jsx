...
import { Search, X, ArrowUpRight, ArrowDownRight, LayoutList } from 'lucide-react';
...
const HistoryView = ({ transactions, onDelete, onEdit }) => {
    ...
    const groupedTransactions = useMemo(() => {
        ...
        filteredTransactions.forEach(t => {
            ...
            if (date.toDateString() === today.toDateString())     key = 'Σήμερα';
            else if (date.toDateString() === yesterday.toDateString()) key = 'Χθες';
        ...
        <div className="pb-28 animate-fade-in space-y-4">
            ...
            {filteredTransactions.length > 0 && (
                <div className="grid grid-cols-2 gap-3">
                    <div className="bg-emerald-50 dark:bg-emerald-900/20
                        ...
                        <div>
                            <p className="text-[10px] font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-wide">Έσοδα</p>
                    ...
                    <div className="bg-rose-50 dark:bg-rose-900/20
                        ...
                        <div>
                            <p className="text-[10px] font-bold text-rose-600 dark:text-rose-400 uppercase tracking-wide">Έξοδα</p>
            ...
            {Object.keys(groupedTransactions).length === 0 ? (
                <div className="text-center py-14">
                    ...
                    <p className="font-semibold text-gray-400 dark:text-gray-500">Δεν βρέθηκαν συναλλαγές</p>
                    <p className="text-xs text-gray-400 dark:text-gray-600 mt-1">Δοκίμασε διαφορετικό φίλτρο</p>
                </div>
            ) : (
                            ...
                            <div key={date}>
                                ...
                                <div className="flex items-center justify-between mb-2.5">
                                    ...
                                    <div className="flex items-center gap-2 text-[10px] font-bold">
                                        {inc > 0 && <span className="text-emerald-500">+{inc.toFixed(0)}€</span>}
                                        {exp > 0 && <span className="text-rose-400">−{exp.toFixed(0)}€</span>}
                                    </div>
                                </div>
